...
import static ru.ts_parser.model.MapHandler.getByValue;
import static ru.ts_parser.model.MapHandler.sortHashMapByKey;
import static ru.ts_parser.MpegCommonData.*;

/**
 * Абстрактный класс, содержащий методы работы с отметками времени
 */
